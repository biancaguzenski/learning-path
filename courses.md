...
## Computer Science
  ...
  | :---: | :---: | --- | --- | --- | --- |
  | Harvard - [CS50](https://online-learning.harvard.edu/course/cs50-introduction-computer-science) | A broad and robust understanding of computer science and programming | Finished | [Repo](https://github.com/biancaguzenski/learning-path/tree/master/Projects) | [Ref](hhttps://github.com/biancaguzenski/learning-path/blob/master/ref.md) | * |
  | University of Washington -[Programming Languages, Part A - ML language](https://www.coursera.org/learn/programming-languages)	| This course is an introduction to the basic concepts of programming languages, with a strong emphasis in functional programming. The course uses the language SML but the real intent is to teach enough about how any language “fits together” to turn you into a more effective programmer. This course will give you a framework for understanding how to use language constructs effectively and how to design correct and elegant programs. | Finished | [Repo](https://github.com/biancaguzenski/learning-path/tree/master/Courses/Prog_Lang_Course_ML) | [Ref](https://github.com/biancaguzenski/learning-path/blob/master/ref.md) | [Link](https://www.coursera.org/account/accomplishments/certificate/QUXSFP4WUWGS) |
  | University of Washington -[Programming Languages, Part B - Racket language](https://www.https://www.coursera.org/learn/programming-languages-part-b)	| This course is an introduction to the basic concepts of programming languages, with a strong emphasis in functional programming. The course uses the languages Racket but the real intent is to teach enough about how any language “ “fits together” to turn you into a more effective programmer. This course will give you a framework for understanding how to use language constructs effectively and how to design correct and elegant programs. | Finished | [Repo](https://github.com/biancaguzenski/learning-path/tree/master/Courses/Prog_Lang_Course_Racket) | [Ref](https://github.com/biancaguzenski/learning-path/blob/master/ref.md) | [Link](https://www.coursera.org/account/accomplishments/certificate/Z57HYC7ZSR9U) |
 ...
 | Course/School | Description | Status | Repo | Books/References | Certificate |
  ...
  | Course/School | Description | Status | Repo | Books/References | Certificate |
  | :---: | :---: | --- | --- | --- | --- |
  | DigitalInovationOne - [Bootcamp Fullstack Developer](https://web.digitalinnovation.one/track/everis-fullstack-developer) | Fullstack development (Finished: Logic, Version control system (git), HTML5, CSS) | In progress | [Ref](https://github.com/biancaguzenski/learning-path/blob/master/ref.md) | [Link](https://web.digitalinnovation.one/users/guzenski)|
...
## In progress
  ...
  | Course/School | Description | Status | Repo | Books/References | Certificate |
  | :---: | :---: | --- | --- | --- | --- |  
  | [Build a Modern Computer from First Principles: From Nand to Tetris](https://www.coursera.org/learn/build-a-computer?courseSlug=build-a-computer&showOnboardingModal=check) | Computer Architecture/OS | In progress | [Repo](https://github.com/biancaguzenski/learning-path/tree/master/Courses/NandToTetris) | [Ref](https://github.com/biancaguzenski/learning-path/blob/master/ref.md) | * |
  | [Build a Modern Computer from First Principles: Nand to Tetris Part II](https://www.coursera.org/learn/nand2tetris2) | Computer Architecture | Not started | Repo | [Ref](https://github.com/biancaguzenski/learning-path/blob/master/ref.md) | |
